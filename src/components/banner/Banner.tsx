...
const Banner = () => {
  return (
    <figure className=" z-10 [clip-path:polygon(0%_0%,100%_0%,100%_90%,0%_100%)]">
      <div className="relative h-[115vh] w-full overflow-hidden bg-gradient-to-r from-blue-950 to-blue-800 flex flex-col items-center justify-center text-white">
        ...
        <div className="flex  justify-center items-center  ">
          <div className="w-1/2 z-10 container mx-auto  px-4">
